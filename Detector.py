...
# img = cv2.imread("multiple_apple(15).png")
# img = cv2.imread("multiple_apple (2).jpg")
# img = cv2.imread("multiple_apple (3).jpg")
# img = cv2.imread("multiple_apple (4).jpg")
# detector.Detect(img)
